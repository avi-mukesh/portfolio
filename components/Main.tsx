...
function NavLink({
  ...
  return (
    <a
      href={href}
      style={{ color: textColor, textDecoration: "none", fontSize: 14 }}
...
function V3Portfolio() {
  ...
  const styles: Record<
    "root" | "mono" | "container" | "nav" | "section",
    React.CSSProperties
  > = {
    root: {
      width: "100%",
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      year: "2023",
      blurb:
        "AWS ML Engineer Nanodegree capstone. Random Forest classifier on a Kaggle Premier League dataset. 60% precision after tuning.",
    },
    {
      name: "80in8",
      lang: "Next.js",
      year: "2026",
      blurb:
        "A mental arithmetic trainer. 80 questions in 8 minutes. Contains maths tips and tricks to help you improve.",
      href: "https://80in8.com",
    },
  ];
  ...
  const timeline: TimelineItem[] = [
    ...
    {
      years: "Feb 2026 — Now",
      role: "Quant Research Bootcamp · Capstone",
      org: "WallStreetQuants",
      detail:
        "12-week buy-side quant program. Capstone is the cross-sectional momentum strategy detailed in Research above.",
    },
    {
      ...
      <div style={styles.container} className="v3-container">
        ...
        <nav style={styles.nav}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <span
              className={showPulse ? "v3-dot v3-pulse" : "v3-dot"}
              style={{ borderRadius: "50%" }}
            ></span>
            <span
              style={{ ...styles.mono, fontSize: 13, letterSpacing: "-0.01em" }}
            >
              avi.mukesh
            </span>
          </div>
            ...
            <div>
              ...
              >
                ...
                >
                  ...
                  <div>
                    <span style={{ color: dim }}>education ——————</span> MMath,
                    Warwick (1st)
                  </div>
                  <div>
                    <span style={{ color: dim }}>current role ———</span> SWE,
                    Singletrack
                  </div>
                  <div>
          ...
          >
            {[
              <>
                ...
                in-sample (2022–2024), against BTC buy-and-hold at 0.68 and an
                equal-weight basket at 0.51. Out-of-sample Sharpe of 0.70 on an
                expanded 17-coin universe. Near-zero beta confirms the alpha is
              ...
              <>
                A BTC regime filter zeros short exposure in bull markets,
                motivated by the empirical finding that the short leg bleeds
                consistently during sustained uptrends. Improves risk-adjusted
                returns across{" "}
                <span style={{ color: accent, fontWeight: 600 }}>all</span>{" "}
                in-sample years.
              </>,
              <>
                Turnover settles at{" "}
                <span style={{ color: accent, fontWeight: 600 }}>0.22</span> at
                20bps/side; net Sharpe stays within 0.7 of gross.
              </>,
              <>
                A 2D parameter sweep across price and tweet lookback windows
          ...
          >
            ...
            >
              <div style={{ fontSize: 16, fontWeight: 500 }}>
                Equity curve (in-sample)
              </div>
            </div>
            <Image
              src="/output-website.png"
              alt="Equity curve — actual backtest output"
              width={1477}
              height={642}
        ...
        <section id="projects" className="v3-section" style={styles.section}>
          ...
          <div
            className="v3-projects-grid"
            style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}
          >
            {projects.map((p) => (
              <a
                key={p.name}
                href={p.href ?? `https://github.com/avi-mukesh/${p.name}`}
                target="_blank"
              ...
              >
                ...
                >
                  <div
                    style={{ ...styles.mono, fontSize: 16, fontWeight: 500 }}
                  >
                    {p.name}
                  </div>
                ...
                <div style={{ fontSize: 15, color: text, lineHeight: 1.55 }}>
                  {p.blurb}
                </div>
                <div
                  style={{
                ...
                >
                  ...
                  <span style={{ ...styles.mono, fontSize: 12, color: accent }}>
                    →
                  </span>
                </div>
              </a>
        ...
        <section id="cv" className="v3-section" style={styles.section}>
          ...
          >
            ...
            <div>
              <div style={{ fontSize: 22, fontWeight: 500 }}>
                MMath Mathematics,{" "}
                <span style={{ color: accent }}>First Class (83%)</span>
              </div>
              <div style={{ fontSize: 16, color: muted, marginTop: 2 }}>
          ...
          <div style={{ marginTop: 56 }}>
            ...
            >
              <div>
                <a
                  href="https://www.udemy.com/certificate/UC-8c114ec5-6614-430e-8135-fe2ce0abdcfb/"
                  target="_blank"
                  rel="noreferrer"
                  className="v3-link"
                >
                ...
                <span style={{ color: muted }}>· Udemy</span>
              </div>
              <div>
                <a
                  href="https://www.udacity.com/certificate/CG9Q6ZDM"
                  target="_blank"
                  rel="noreferrer"
                  className="v3-link"
                >
                ...
                <span style={{ color: muted }}>· AWS / Udacity</span>
              </div>
              <div>
                <a
                  href="https://www.coursera.org/account/accomplishments/verify/43IRUEZ2XGCY"
                  target="_blank"
                  rel="noreferrer"
                  className="v3-link"
                >
                ...
                <span style={{ color: muted }}>· Stanford / Coursera</span>
              </div>
            </div>
          </div>
        </section>
        ...
        >
          ...
          >
            {/* Speedcubing card */}
            <div
              className="v3-card v3-card-padded"
              style={{
                padding: 32,
                display: "flex",
            ...
            >
                ...
                {[
                  ...
                  <div key={r.label}>
                    ...
                    >
                      ...
                      {r.unit && (
                        <span
                          style={{ ...styles.mono, fontSize: 11, color: dim }}
                        >
                          {r.unit}
                        </span>
                      )}
              ...
              <a
                href="https://www.worldcubeassociation.org/persons/2020MUKE01"
                target="_blank"
                rel="noreferrer"
                className="v3-link"
                style={{
            ...
            <div
              style={{ display: "grid", gridTemplateRows: "1fr 1fr", gap: 20 }}
            >
              <div
                className="v3-card"
                style={{
              ...
              >
                ...
                >
                  <span>
                    total <span style={{ color: text }}>445</span>&nbsp;kg
                  </span>
                  <span>
                    @ <span style={{ color: text }}>72</span>&nbsp;kg BW
                  </span>
                </div>
              </div>
        ...
        >
          ...
          >
            <a
              ...
              rel="noopener noreferrer"
            >
              github.com/avi-mukesh ↗
            </a>
            <a
              className="v3-link"
              href="https://www.linkedin.com/in/avi-mukesh/"
              target="_blank"
              rel="noopener noreferrer"
            >
              linkedin.com/in/avi-mukesh ↗
            </a>
          </div>
          <div
            className="v3-footer-row"
            style={{
              marginTop: 96,
              paddingTop: 24,
              paddingBottom: 40,
